...
async def enforce_policies(request: EnforceRequest) -> EnforceResponse:
    ...
    This endpoint:
    1. Receives a structured plan from INTENT
    2. Evaluates it against applicable BASIS policies
    3. Returns a verdict (allow/deny/escalate/modify)
    4. Logs the decision for PROOF
